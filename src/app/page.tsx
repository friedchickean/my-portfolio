      ...
      <section className="min-h-screen">
        ...
        <div className='p-16 lg:p-32'>
          ...
          <div className='pt-20 text-4xl flex justify-center gap-14 lg:gap-20'>
            <a href="https://github.com/friedchickean" target="_blank" rel="noopener noreferrer">
              <BsGithub />
            </a>
            <a href="https://linkedin.com/in/kean-arguelles" target="_blank" rel="noopener noreferrer">
              <BsLinkedin />
            </a>
            <a href="mailto:arguelleskean@gmail.com">
              <MdEmail />
            </a>
            <a href="tel:+14034378329">
              <BsTelephoneFill />
            </a>
            <a href="https://instagram.com/friedchic.kean" target="_blank" rel="noopener noreferrer">
              <BsInstagram />
            </a>
          </div>
          ...
          <div className='pb-10 flex flex-col items-center lg:flex-row lg:items-start'>
            ...
            <div className='lg:w-2/3 lg:text-right lg:pl-20'>
              ...
              <h2 className='text-xl lg:text-2xl pb-5 text-cyan-500 lg:pt-10'>
          ...
          {/* More About me */}
          <div>
            <h1 className=' text-5xl text-cyan-600 pt-10 lg:pt-0'>More about me...</h1>
          </div>
